...
class PearsonsContingencyCoefficient(Metric):
    ...
    - ``pearsons_cc`` (:class:`~paddle.Tensor`): Scalar tensor containing the Pearsons Contingency Coefficient statistic.
    ...
    Example::
        ...
        >>> from paddlemetrics.nominal import PearsonsContingencyCoefficient
