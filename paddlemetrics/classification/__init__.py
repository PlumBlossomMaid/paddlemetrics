...
from paddlemetrics.classification.cohen_kappa import BinaryCohenKappa, CohenKappa, MulticlassCohenKappa
...
from paddlemetrics.classification.eer import EER, BinaryEER, MulticlassEER, MultilabelEER
from paddlemetrics.classification.exact_match import ExactMatch, MulticlassExactMatch, MultilabelExactMatch
from paddlemetrics.classification.f_beta import (
    BinaryF1Score,
    BinaryFBetaScore,
    F1Score,
    FBetaScore,
...
from paddlemetrics.classification.group_fairness import BinaryFairness, BinaryGroupStatRates
from paddlemetrics.classification.hamming import (
...
from paddlemetrics.classification.jaccard import (
    BinaryJaccardIndex,
    JaccardIndex,
...
from paddlemetrics.classification.precision_recall import (
    BinaryPrecision,
    BinaryRecall,
    MulticlassPrecision,
    MulticlassRecall,
