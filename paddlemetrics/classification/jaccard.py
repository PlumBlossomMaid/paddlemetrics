...
class BinaryJaccardIndex(BinaryConfusionMatrix):
    ...
    Example (preds is int tensor):
        ...
        >>> from paddlemetrics.classification import BinaryJaccardIndex
...
class MulticlassJaccardIndex(MulticlassConfusionMatrix):
    ...
    Example (pred is integer tensor):
        >>> from paddle import tensor
        >>> from paddlemetrics.classification import MulticlassJaccardIndex
...
class MultilabelJaccardIndex(MultilabelConfusionMatrix):
    ...
    Example (preds is int tensor):
        >>> from paddle import tensor
        >>> from paddlemetrics.classification import MultilabelJaccardIndex
...
class JaccardIndex(_ClassificationTaskWrapper):
    ...
    :class:`~paddlemetrics.classification.BinaryJaccardIndex`,
    :class:`~paddlemetrics.classification.MulticlassJaccardIndex` and
    :class:`~paddlemetrics.classification.MultilabelJaccardIndex` for the specific details of each argument influence
    and examples.
