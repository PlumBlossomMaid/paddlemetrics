...
class BinaryAveragePrecision(BinaryPrecisionRecallCurve):
    ...
    Example:
        ...
        >>> from paddlemetrics.classification import BinaryAveragePrecision
...
class MulticlassAveragePrecision(MulticlassPrecisionRecallCurve):
    ...
    Example:
        >>> from paddle import tensor
        >>> from paddlemetrics.classification import MulticlassAveragePrecision
...
class MultilabelAveragePrecision(MultilabelPrecisionRecallCurve):
    ...
    Example:
        >>> from paddle import tensor
        >>> from paddlemetrics.classification import MultilabelAveragePrecision
