...
class MultilabelCoverageError(Metric):
    ...
    Example:
        ...
        >>> from paddlemetrics.classification import MultilabelCoverageError
        >>> preds = rand(10, 5)
    ...
    def __init__(
        ...
        **kwargs: Any,
        ...
        self.add_state("measure", paddle.tensor(0.0), dist_reduce_fx="sum")
        self.add_state("total", paddle.tensor(0.0), dist_reduce_fx="sum")
...
class MultilabelRankingAveragePrecision(Metric):
    ...
    Example:
        >>> from paddle import rand, randint
        >>> from paddlemetrics.classification import MultilabelRankingAveragePrecision
        >>> preds = rand(10, 5)
        >>> target = randint(2, (10, 5))
...
class MultilabelRankingLoss(Metric):
    ...
    Example:
        >>> from paddle import rand, randint
        >>> from paddlemetrics.classification import MultilabelRankingLoss
        >>> preds = rand(10, 5)
        >>> target = randint(2, (10, 5))
