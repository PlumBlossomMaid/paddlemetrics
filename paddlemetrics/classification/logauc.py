...
class BinaryLogAUC(BinaryROC):
    ...
    Example:
        ...
        >>> from paddlemetrics.classification import BinaryLogAUC
...
class MulticlassLogAUC(MulticlassROC):
    ...
    Example:
        >>> from paddle import tensor
        >>> from paddlemetrics.classification import MulticlassLogAUC
        >>> preds = tensor([[0.75, 0.05, 0.05, 0.05, 0.05],
...
class MultilabelLogAUC(MultilabelROC):
    ...
    Example:
        >>> from paddle import tensor
        >>> from paddlemetrics.classification import MultilabelLogAUC
...
class LogAUC(_ClassificationTaskWrapper):
    ...
    :class:`~paddlemetrics.classification.BinaryLogAUC`, :class:`~paddlemetrics.classification.MulticlassLogAUC` and
    :class:`~paddlemetrics.classification.MultilabelLogAUC` for the specific details of each argument influence and
    examples.
