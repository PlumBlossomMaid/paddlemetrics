...
class BinaryROC(BinaryPrecisionRecallCurve):
    ...
    Example:
        ...
        >>> from paddlemetrics.classification import BinaryROC
...
class MulticlassROC(MulticlassPrecisionRecallCurve):
    ...
    Example:
        >>> from paddle import tensor
        >>> from paddlemetrics.classification import MulticlassROC
...
class MultilabelROC(MultilabelPrecisionRecallCurve):
    ...
    Example:
        >>> from paddle import tensor
        >>> from paddlemetrics.classification import MultilabelROC
...
class ROC(_ClassificationTaskWrapper):
    ...
    :class:`~paddlemetrics.classification.BinaryROC`,
    :class:`~paddlemetrics.classification.MulticlassROC` and
    :class:`~paddlemetrics.classification.MultilabelROC` for the specific details of each argument
