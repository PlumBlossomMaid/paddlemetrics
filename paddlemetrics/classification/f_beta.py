...
class BinaryFBetaScore(BinaryStatScores):
    ...
    Example (preds is int tensor):
        >>> from paddle import tensor
        >>> from paddlemetrics.classification import BinaryFBetaScore
...
class MulticlassFBetaScore(MulticlassStatScores):
    ...
    Example (preds is int tensor):
        >>> from paddle import tensor
        >>> from paddlemetrics.classification import MulticlassFBetaScore
...
class MultilabelFBetaScore(MultilabelStatScores):
    ...
    Example (preds is int tensor):
        >>> from paddle import tensor
        >>> from paddlemetrics.classification import MultilabelFBetaScore
        >>> target = tensor([[0, 1, 0], [1, 0, 1]])
        >>> preds = tensor([[0, 0, 1], [1, 0, 1]])
...
class BinaryF1Score(BinaryFBetaScore):
    ...
    Example (preds is int tensor):
        >>> from paddle import tensor
        >>> from paddlemetrics.classification import BinaryF1Score
        >>> target = tensor([0, 1, 0, 1, 0, 1])
        >>> preds = tensor([0, 0, 1, 1, 0, 1])
...
class MultilabelF1Score(MultilabelFBetaScore):
    ...
    Example (preds is int tensor):
        >>> from paddle import tensor
        >>> from paddlemetrics.classification import MultilabelF1Score
        >>> target = tensor([[0, 1, 0], [1, 0, 1]])
        >>> preds = tensor([[0, 0, 1], [1, 0, 1]])
...
class FBetaScore(_ClassificationTaskWrapper):
    ...
    :class:`~paddlemetrics.classification.BinaryFBetaScore`,
    :class:`~paddlemetrics.classification.MulticlassFBetaScore` and
    :class:`~paddlemetrics.classification.MultilabelFBetaScore` for the specific details of each argument influence
    and examples.
...
class F1Score(_ClassificationTaskWrapper):
    ...
    This function is a simple wrapper to get the task specific versions of this metric, which is done by setting the
    ``task`` argument to either ``'binary'``, ``'multiclass'`` or ``'multilabel'``. See the documentation of
    :class:`~paddlemetrics.classification.BinaryF1Score`, :class:`~paddlemetrics.classification.MulticlassF1Score` and
    :class:`~paddlemetrics.classification.MultilabelF1Score` for the specific details of each argument influence and
    examples.
