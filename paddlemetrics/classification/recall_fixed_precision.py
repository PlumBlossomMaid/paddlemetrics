...
class BinaryRecallAtFixedPrecision(BinaryPrecisionRecallCurve):
    ...
    Example:
        ...
        >>> from paddlemetrics.classification import BinaryRecallAtFixedPrecision
...
class MulticlassRecallAtFixedPrecision(MulticlassPrecisionRecallCurve):
    ...
    Example:
        >>> from paddle import tensor
        >>> from paddlemetrics.classification import MulticlassRecallAtFixedPrecision
...
class MultilabelRecallAtFixedPrecision(MultilabelPrecisionRecallCurve):
    ...
    Example:
        >>> from paddle import tensor
        >>> from paddlemetrics.classification import MultilabelRecallAtFixedPrecision
...
class RecallAtFixedPrecision(_ClassificationTaskWrapper):
    ...
    :class:`~paddlemetrics.classification.BinaryRecallAtFixedPrecision`,
    :class:`~paddlemetrics.classification.MulticlassRecallAtFixedPrecision` and
    :class:`~paddlemetrics.classification.MultilabelRecallAtFixedPrecision` for the specific details of each argument
