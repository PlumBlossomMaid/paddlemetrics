...
class BinaryHingeLoss(Metric):
    ...
    Example:
        >>> from paddlemetrics.classification import BinaryHingeLoss
    ...
    def __init__(
        ...
        **kwargs: Any,
        ...
        self.add_state("measures", default=paddle.tensor(0.0), dist_reduce_fx="sum")
...
class MulticlassHingeLoss(Metric):
    ...
    Example:
        >>> from paddlemetrics.classification import MulticlassHingeLoss
...
class HingeLoss(_ClassificationTaskWrapper):
    ...
    :class:`~paddlemetrics.classification.BinaryHingeLoss` and :class:`~paddlemetrics.classification.MulticlassHingeLoss`
