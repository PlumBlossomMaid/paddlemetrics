...
from paddlemetrics.functional.classification.negative_predictive_value import _negative_predictive_value_reduce
...
class BinaryNegativePredictiveValue(BinaryStatScores):
    ...
    Example (preds is int tensor):
        ...
        >>> from paddlemetrics.classification import BinaryNegativePredictiveValue
...
class MulticlassNegativePredictiveValue(MulticlassStatScores):
    ...
    Example (preds is int tensor):
        >>> from paddle import tensor
        >>> from paddlemetrics.classification import MulticlassNegativePredictiveValue
...
class MultilabelNegativePredictiveValue(MultilabelStatScores):
    ...
    Example (preds is int tensor):
        >>> from paddle import tensor
        >>> from paddlemetrics.classification import MultilabelNegativePredictiveValue
        >>> target = tensor([[0, 1, 0], [1, 0, 1]])
        >>> preds = tensor([[0, 0, 1], [1, 0, 1]])
...
class NegativePredictiveValue(_ClassificationTaskWrapper):
    ...
    :class:`~paddlemetrics.classification.BinaryNegativePredictiveValue`,
    :class:`~paddlemetrics.classification.MulticlassNegativePredictiveValue`
    and :class:`~paddlemetrics.classification.MultilabelNegativePredictiveValue` for the specific details of each
