...
class BinarySensitivityAtSpecificity(BinaryPrecisionRecallCurve):
    ...
    Example:
        >>> from paddlemetrics.classification import BinarySensitivityAtSpecificity
    ...
    def compute(self) -> tuple[paddle.Tensor, paddle.Tensor]:
        ...
        return _binary_sensitivity_at_specificity_compute(
            state, self.thresholds, self.min_specificity
        )
...
class MulticlassSensitivityAtSpecificity(MulticlassPrecisionRecallCurve):
    ...
    Example:
        >>> from paddlemetrics.classification import MulticlassSensitivityAtSpecificity
        >>> from paddle import tensor
...
class MultilabelSensitivityAtSpecificity(MultilabelPrecisionRecallCurve):
    ...
    Example:
        >>> from paddlemetrics.classification import MultilabelSensitivityAtSpecificity
        >>> from paddle import tensor
...
class SensitivityAtSpecificity(_ClassificationTaskWrapper):
    ...
    :class:`~paddlemetrics.classification.BinarySensitivityAtSpecificity`,
    :class:`~paddlemetrics.classification.MulticlassSensitivityAtSpecificity` and
    :class:`~paddlemetrics.classification.MultilabelSensitivityAtSpecificity` for the specific details of each argument
    ...
    def __new__(
        ...
        **kwargs: Any,
        ...
        if task == ClassificationTask.BINARY:
            return BinarySensitivityAtSpecificity(
                min_specificity, thresholds, ignore_index, validate_args, **kwargs
            )
