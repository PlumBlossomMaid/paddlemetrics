...
class BinaryPrecisionAtFixedRecall(BinaryPrecisionRecallCurve):
    ...
    Example:
        ...
        >>> from paddlemetrics.classification import BinaryPrecisionAtFixedRecall
...
class MulticlassPrecisionAtFixedRecall(MulticlassPrecisionRecallCurve):
    ...
    Example:
        >>> from paddle import tensor
        >>> from paddlemetrics.classification import MulticlassPrecisionAtFixedRecall
...
class MultilabelPrecisionAtFixedRecall(MultilabelPrecisionRecallCurve):
    ...
    Example:
        >>> from paddle import tensor
        >>> from paddlemetrics.classification import MultilabelPrecisionAtFixedRecall
...
class PrecisionAtFixedRecall(_ClassificationTaskWrapper):
    ...
    :class:`~paddlemetrics.classification.BinaryPrecisionAtFixedRecall`,
    :class:`~paddlemetrics.classification.MulticlassPrecisionAtFixedRecall` and
    :class:`~paddlemetrics.classification.MultilabelPrecisionAtFixedRecall` for the specific details of each argument
