...
class BinaryConfusionMatrix(Metric):
    ...
    Example (preds is int tensor):
        >>> from paddlemetrics.classification import BinaryConfusionMatrix
    ...
    def plot(
        self,
        val: Optional[paddle.Tensor] = None,
        ...
        .. plot::
            ...
            >>> from paddlemetrics.classification import MulticlassConfusionMatrix
...
class MultilabelConfusionMatrix(Metric):
    ...
    Example (preds is int tensor):
        >>> from paddle import tensor
        >>> from paddlemetrics.classification import MultilabelConfusionMatrix
...
class ConfusionMatrix(_ClassificationTaskWrapper):
    ...
    :class:`~paddlemetrics.classification.BinaryConfusionMatrix`,
    :class:`~paddlemetrics.classification.MulticlassConfusionMatrix` and
    :class:`~paddlemetrics.classification.MultilabelConfusionMatrix` for the specific details of each argument influence
    and examples.
