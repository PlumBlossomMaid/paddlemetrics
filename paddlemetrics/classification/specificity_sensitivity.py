...
class BinarySpecificityAtSensitivity(BinaryPrecisionRecallCurve):
    ...
    Example:
        >>> from paddlemetrics.classification import BinarySpecificityAtSensitivity
...
class MulticlassSpecificityAtSensitivity(MulticlassPrecisionRecallCurve):
    ...
    Example:
        >>> from paddlemetrics.classification import MulticlassSpecificityAtSensitivity
        >>> from paddle import tensor
...
class MultilabelSpecificityAtSensitivity(MultilabelPrecisionRecallCurve):
    ...
    Example:
        >>> from paddlemetrics.classification import MultilabelSpecificityAtSensitivity
        >>> from paddle import tensor
...
class SpecificityAtSensitivity(_ClassificationTaskWrapper):
    ...
    :class:`~paddlemetrics.classification.BinarySpecificityAtSensitivity`,
    :class:`~paddlemetrics.classification.MulticlassSpecificityAtSensitivity` and
    :class:`~paddlemetrics.classification.MultilabelSpecificityAtSensitivity` for the specific details of each argument
