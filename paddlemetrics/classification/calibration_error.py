...
class BinaryCalibrationError(Metric):
    ...
    Example:
        ...
        >>> from paddlemetrics.classification import BinaryCalibrationError
...
class MulticlassCalibrationError(Metric):
    ...
    Example:
        >>> from paddle import tensor
        >>> from paddlemetrics.classification import MulticlassCalibrationError
...
class CalibrationError(_ClassificationTaskWrapper):
    ...
    :class:`~paddlemetrics.classification.BinaryCalibrationError` and
    :class:`~paddlemetrics.classification.MulticlassCalibrationError` for the specific details of each argument influence
    and examples.
