...
class BinaryAUROC(BinaryPrecisionRecallCurve):
    ...
    Example:
        ...
        >>> from paddlemetrics.classification import BinaryAUROC
...
class MulticlassAUROC(MulticlassPrecisionRecallCurve):
    ...
    Example:
        >>> from paddle import tensor
        >>> from paddlemetrics.classification import MulticlassAUROC
...
class MultilabelAUROC(MultilabelPrecisionRecallCurve):
    ...
    Example:
        >>> from paddle import tensor
        >>> from paddlemetrics.classification import MultilabelAUROC
...
class AUROC(_ClassificationTaskWrapper):
    ...
    :class:`~paddlemetrics.classification.BinaryAUROC`, :class:`~paddlemetrics.classification.MulticlassAUROC` and
    :class:`~paddlemetrics.classification.MultilabelAUROC` for the specific details of each argument influence and
    examples.
