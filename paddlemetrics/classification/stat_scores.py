...
class _AbstractStatScores(Metric):
    tp: Union[List[paddle.Tensor], paddle.Tensor]
    fp: Union[List[paddle.Tensor], paddle.Tensor]
...
class BinaryStatScores(_AbstractStatScores):
    ...
    Example (preds is int tensor):
        ...
        >>> from paddlemetrics.classification import BinaryStatScores
...
class MulticlassStatScores(_AbstractStatScores):
    ...
    Example (preds is int tensor):
        >>> from paddle import tensor
        >>> from paddlemetrics.classification import MulticlassStatScores
...
class MultilabelStatScores(_AbstractStatScores):
    ...
    Example (preds is int tensor):
        >>> from paddle import tensor
        >>> from paddlemetrics.classification import MultilabelStatScores
        >>> target = tensor([[0, 1, 0], [1, 0, 1]])
        >>> preds = tensor([[0, 0, 1], [1, 0, 1]])
...
class StatScores(Metric):
    ...
    :class:`~paddlemetrics.classification.BinaryStatScores`, :class:`~paddlemetrics.classification.MulticlassStatScores`
    and :class:`~paddlemetrics.classification.MultilabelStatScores` for the specific details of each argument influence
    and examples.
