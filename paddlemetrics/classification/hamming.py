...
class BinaryHammingDistance(BinaryStatScores):
    ...
    Example (preds is int tensor):
        ...
        >>> from paddlemetrics.classification import BinaryHammingDistance
...
class MulticlassHammingDistance(MulticlassStatScores):
    ...
    Example (preds is int tensor):
        >>> from paddle import tensor
        >>> from paddlemetrics.classification import MulticlassHammingDistance
...
class MultilabelHammingDistance(MultilabelStatScores):
    ...
    Example (preds is int tensor):
        >>> from paddle import tensor
        >>> from paddlemetrics.classification import MultilabelHammingDistance
        >>> target = tensor([[0, 1, 0], [1, 0, 1]])
        >>> preds = tensor([[0, 0, 1], [1, 0, 1]])
...
class HammingDistance(_ClassificationTaskWrapper):
    ...
    :class:`~paddlemetrics.classification.BinaryHammingDistance`,
    :class:`~paddlemetrics.classification.MulticlassHammingDistance` and
    :class:`~paddlemetrics.classification.MultilabelHammingDistance` for the specific details of each argument influence
    and examples.
