...
class MulticlassExactMatch(Metric):
    ...
    Example (multidim tensors):
        >>> from paddle import tensor
        >>> from paddlemetrics.classification import MulticlassExactMatch
...
class MultilabelExactMatch(Metric):
    ...
    Example (preds is int tensor):
        >>> from paddle import tensor
        >>> from paddlemetrics.classification import MultilabelExactMatch
...
class ExactMatch(_ClassificationTaskWrapper):
    ...
    :class:`~paddlemetrics.classification.MulticlassExactMatch` and
    :class:`~paddlemetrics.classification.MultilabelExactMatch` for the specific details of each argument influence and
    examples.
