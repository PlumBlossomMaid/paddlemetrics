...
class BinaryCohenKappa(BinaryConfusionMatrix):
    ...
    Example (preds is int tensor):
        ...
        >>> from paddlemetrics.classification import BinaryCohenKappa
...
class MulticlassCohenKappa(MulticlassConfusionMatrix):
    ...
    Example (pred is integer tensor):
        >>> from paddle import tensor
        >>> from paddlemetrics.classification import MulticlassCohenKappa
...
class CohenKappa(_ClassificationTaskWrapper):
    ...
    :class:`~paddlemetrics.classification.BinaryCohenKappa` and
    :class:`~paddlemetrics.classification.MulticlassCohenKappa` for the specific details of each argument influence and
    examples.
