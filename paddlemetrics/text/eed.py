...
from paddlemetrics.functional.text.eed import _eed_compute, _eed_update
...
class ExtendedEditDistance(Metric):
    ...
    - ``eed`` (:class:`~paddle.Tensor`): A tensor with the extended edit distance score
    ...
    Example:
        >>> from paddlemetrics.text import ExtendedEditDistance
    ...
    sentence_eed: List[paddle.Tensor]
    ...
    def compute(self) -> Union[paddle.Tensor, tuple[paddle.Tensor, paddle.Tensor]]:
        ...
        if self.return_sentence_level_score:
            return average, paddle.stack(self.sentence_eed)
        return average
