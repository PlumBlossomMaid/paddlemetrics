...
from paddlemetrics.functional.text.mer import _mer_compute, _mer_update
...
class MatchErrorRate(Metric):
    """Match Error Rate (`MER`_) is a common metric of the performance of an automatic speech recognition system.
    ...
    - ``mer`` (:class:`~paddle.Tensor`): A tensor with the match error rate

    Args:
        kwargs: Additional keyword arguments, see :ref:`Metric kwargs` for more info.

    Examples:
        >>> from paddlemetrics.text import MatchErrorRate
