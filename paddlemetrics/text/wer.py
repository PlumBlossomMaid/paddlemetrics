...
class WordErrorRate(Metric):
    """Word error rate (`WordErrorRate`_) is a common metric of the performance of an automatic speech recognition.
    ...
    -  ``wer`` (:class:`~paddle.Tensor`): A tensor with the Word Error Rate score

    Args:
        kwargs: Additional keyword arguments, see :ref:`Metric kwargs` for more info.

    Examples:
        >>> from paddlemetrics.text import WordErrorRate
