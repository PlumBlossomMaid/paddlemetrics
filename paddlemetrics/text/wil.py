...
class WordInfoLost(Metric):
    """Word Information Lost (`WIL`_) is a metric of the performance of an automatic speech recognition system.
    ...
    - ``wil`` (:class:`~paddle.Tensor`): A tensor with the Word Information Lost score

    Args:
        kwargs: Additional keyword arguments, see :ref:`Metric kwargs` for more info.

    Examples:
        >>> from paddlemetrics.text import WordInfoLost
