...
from paddlemetrics.functional.text.cer import _cer_compute, _cer_update
...
class CharErrorRate(Metric):
    """Character Error Rate (`CER`_) is a metric of the performance of an automatic speech recognition (ASR) system.
    ...
    -  ``cer`` (:class:`~paddle.Tensor`): A tensor with the Character Error Rate score

    Args:
        kwargs: Additional keyword arguments, see :ref:`Metric kwargs` for more info.

    Examples:
        >>> from paddlemetrics.text import CharErrorRate
