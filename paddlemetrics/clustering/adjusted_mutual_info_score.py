...
from paddlemetrics.functional.clustering.adjusted_mutual_info_score import (
    _validate_average_method_arg, adjusted_mutual_info_score)
...
class AdjustedMutualInfoScore(MutualInfoScore):
    ...
    - ``ami_score`` (:class:`~paddle.Tensor`): A tensor with the Adjusted Mutual Information Score
    ...
    Example::
        >>> import paddle
        >>> from paddlemetrics.clustering import AdjustedMutualInfoScore
