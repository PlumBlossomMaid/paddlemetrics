...
from paddlemetrics.functional.detection.ciou import _ciou_compute, _ciou_update
...
if not _TORCHVISION_AVAILABLE:
    __doctest_skip__ = [
        ...
        "CompleteIntersectionOverUnion.plot",
    ]
...
class CompleteIntersectionOverUnion(IntersectionOverUnion):
    """Computes Complete Intersection Over Union (`CIoU`_).
    ...
    - ``ciou_dict``: A dictionary containing the following key-values:
        ...
        - ciou: (:class:`~paddle.Tensor`) with overall ciou value over all classes and samples.
        - ciou/cl_{cl}: (:class:`~paddle.Tensor`), if argument ``class_metrics=True``
    ...
    Example:
        >>> import paddle
        >>> from paddlemetrics.detection import CompleteIntersectionOverUnion
        >>> preds = [
        ...    {
    ...
    def plot(
        ...
        .. plot::
            ...
            >>> target = lambda : [
            ...    {
            ...        "boxes": paddle.to_tensor([[300.00, 100.00, 315.00, 150.00]]) + paddle.randint(-10, 10, (1, 4)),
            ...        "labels": paddle.to_tensor([5]),
            ...    }
            ... ]
            >>> metric = CompleteIntersectionOverUnion()
