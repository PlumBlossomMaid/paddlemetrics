...
class TweedieDevianceScore(Metric):
    ...
    Example:
        >>> from paddlemetrics.regression import TweedieDevianceScore
    ...
    def __init__(self, power: float = 0.0, **kwargs: Any) -> None:
        ...
        self.add_state("sum_deviance_score", paddle.tensor(0.0), dist_reduce_fx="sum")
        self.add_state("num_observations", paddle.tensor(0), dist_reduce_fx="sum")
