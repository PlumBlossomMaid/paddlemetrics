...
class MeanAbsolutePercentageError(Metric):
    ...
    - ``mean_abs_percentage_error`` (:class:`~paddle.Tensor`): A tensor with the mean absolute percentage error over
      state
    ...
    Example:
        >>> from paddle import tensor
        >>> from paddlemetrics.regression import MeanAbsolutePercentageError
