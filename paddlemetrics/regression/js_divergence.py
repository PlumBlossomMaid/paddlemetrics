...
from paddlemetrics.functional.regression.js_divergence import _jsd_compute, _jsd_update
...
class JensenShannonDivergence(Metric):
    ...
    - ``js_divergence`` (:class:`~paddle.Tensor`): A tensor with the Jensen-Shannon divergence
    ...
    Example:
        >>> from paddle import tensor
        >>> from paddlemetrics.regression import JensenShannonDivergence
    ...
    measures: Union[paddle.Tensor, List[paddle.Tensor]]
    total: Tensor
    ...
    def __init__(
        ...
        **kwargs: Any,
        ...
        self.add_state("total", paddle.tensor(0), dist_reduce_fx="sum")
