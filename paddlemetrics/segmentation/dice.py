...
class DiceScore(Metric):
    ...
    As output to ``forward`` and ``compute`` the metric returns the following output:
        ...
        - ``gds`` (:class:`~paddle.Tensor`): The dice score. If ``average`` is set to ``None`` or ``"none"`` the output
    ...
    Example:
        ...
        >>> from paddlemetrics.segmentation import DiceScore
    ...
    numerator: List[paddle.Tensor]
    denominator: List[paddle.Tensor]
    support: List[paddle.Tensor]
    ...
    def plot(
        ...
        .. plot::
            ...
            >>> metric.update(paddle.randint(0, 2, (10, 3, 128, 128)), paddle.randint(0, 2, (10, 3, 128, 128)))
        ...
        .. plot::
            ...
            >>> for _ in range(10):
            ...     values.append(
            ...        metric(paddle.randint(0, 2, (10, 3, 128, 128)), paddle.randint(0, 2, (10, 3, 128, 128)))
            ...     )
