...
from paddlemetrics.functional.pairwise.manhattan import pairwise_manhattan_distance
from paddlemetrics.functional.pairwise.minkowski import pairwise_minkowski_distance
