...
def binary_eer(
    ...
    Example:
        >>> from paddlemetrics.functional.classification import binary_eer
...
def multiclass_eer(
    ...
    Example:
        >>> from paddlemetrics.functional.classification import multiclass_eer
...
def multilabel_eer(
    ...
    Example:
        >>> from paddlemetrics.functional.classification import multilabel_eer
...
def eer(
    ...
    :func:`~paddlemetrics.functional.classification.binary_eer`,
    :func:`~paddlemetrics.functional.classification.multiclass_eer` and
    :func:`~paddlemetrics.functional.classification.multilabel_eer` for the specific details of
    ...
    Legacy Example:
        >>> from paddlemetrics.functional.classification import eer
