...
def _binary_logauc_compute(
    ...
    tpr = paddle.concat([tpr, interp(fpr_range, fpr, tpr)]).sort()
...
def binary_logauc(
    ...
    Example:
        >>> from paddlemetrics.functional.classification import binary_logauc
...
def multiclass_logauc(
    ...
    Example:
        >>> from paddlemetrics.functional.classification import multiclass_logauc
...
def multilabel_logauc(
    ...
    Example:
        >>> from paddlemetrics.functional.classification import multilabel_logauc
