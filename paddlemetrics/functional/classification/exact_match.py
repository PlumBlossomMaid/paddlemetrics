...
def multiclass_exact_match(
    ...
    Example (multidim tensors):
        >>> from paddle import tensor
        >>> from paddlemetrics.functional.classification import multiclass_exact_match
...
def multilabel_exact_match(
    ...
    Example (preds is int tensor):
        >>> from paddle import tensor
        >>> from paddlemetrics.functional.classification import multilabel_exact_match
...
def exact_match(
    ...
    :func:`~paddlemetrics.functional.classification.multiclass_exact_match` and
    :func:`~paddlemetrics.functional.classification.multilabel_exact_match` for the specific details of
