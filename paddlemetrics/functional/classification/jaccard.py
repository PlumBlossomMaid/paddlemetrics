...
def binary_jaccard_index(
    ...
    Example (preds is int tensor):
        >>> from paddle import tensor
        >>> from paddlemetrics.functional.classification import binary_jaccard_index
...
def multiclass_jaccard_index(
    ...
    Example (pred is integer tensor):
        >>> from paddle import tensor
        >>> from paddlemetrics.functional.classification import multiclass_jaccard_index
...
def multilabel_jaccard_index(
    ...
    Example (preds is int tensor):
        >>> from paddle import tensor
        >>> from paddlemetrics.functional.classification import multilabel_jaccard_index
...
def jaccard_index(
    ...
    :func:`~paddlemetrics.functional.classification.binary_jaccard_index`,
    :func:`~paddlemetrics.functional.classification.multiclass_jaccard_index` and
    :func:`~paddlemetrics.functional.classification.multilabel_jaccard_index` for
