...
from paddlemetrics.utils.data import _bincount, select_topk
...
def binary_stat_scores(
    ...
    Example (preds is int tensor):
        >>> from paddle import tensor
        >>> from paddlemetrics.functional.classification import binary_stat_scores
...
def multiclass_stat_scores(
    ...
    Example (preds is int tensor):
        >>> from paddle import tensor
        >>> from paddlemetrics.functional.classification import multiclass_stat_scores
...
def multilabel_stat_scores(
    ...
    Example (preds is int tensor):
        >>> from paddle import tensor
        >>> from paddlemetrics.functional.classification import multilabel_stat_scores
        >>> target = tensor([[0, 1, 0], [1, 0, 1]])
        >>> preds = tensor([[0, 0, 1], [1, 0, 1]])
...
def stat_scores(
    ...
    :func:`~paddlemetrics.functional.classification.binary_stat_scores`,
    :func:`~paddlemetrics.functional.classification.multiclass_stat_scores` and
    :func:`~paddlemetrics.functional.classification.multilabel_stat_scores` for the specific
