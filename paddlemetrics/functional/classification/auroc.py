...
def _reduce_auroc(
    fpr: Union[paddle.Tensor, List[paddle.Tensor]],
...
def binary_auroc(
    ...
    Example:
        >>> from paddlemetrics.functional.classification import binary_auroc
...
def multiclass_auroc(
    ...
    Example:
        >>> from paddlemetrics.functional.classification import multiclass_auroc
...
def multilabel_auroc(
    ...
    Example:
        >>> from paddlemetrics.functional.classification import multilabel_auroc
...
def auroc(
    ...
    :func:`~paddlemetrics.functional.classification.binary_auroc`,
    :func:`~paddlemetrics.functional.classification.multiclass_auroc` and
    :func:`~paddlemetrics.functional.classification.multilabel_auroc` for the specific details of
