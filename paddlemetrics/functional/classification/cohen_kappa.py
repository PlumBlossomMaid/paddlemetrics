...
def binary_cohen_kappa(
    ...
    Example (preds is int tensor):
        >>> from paddle import tensor
        >>> from paddlemetrics.functional.classification import binary_cohen_kappa
...
def multiclass_cohen_kappa(
    ...
    Example (pred is integer tensor):
        >>> from paddle import tensor
        >>> from paddlemetrics.functional.classification import multiclass_cohen_kappa
...
def cohen_kappa(
    ...
    :func:`~paddlemetrics.functional.classification.binary_cohen_kappa` and
    :func:`~paddlemetrics.functional.classification.multiclass_cohen_kappa` for the specific details of
