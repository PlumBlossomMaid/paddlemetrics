...
def binary_recall_at_fixed_precision(
    ...
    Example:
        >>> from paddlemetrics.functional.classification import binary_recall_at_fixed_precision
...
def multiclass_recall_at_fixed_precision(
    ...
    Example:
        >>> from paddlemetrics.functional.classification import multiclass_recall_at_fixed_precision
...
def multilabel_recall_at_fixed_precision(
    ...
    Example:
        >>> from paddlemetrics.functional.classification import multilabel_recall_at_fixed_precision
...
def recall_at_fixed_precision(
    ...
    :func:`~paddlemetrics.functional.classification.binary_recall_at_fixed_precision`,
    :func:`~paddlemetrics.functional.classification.multiclass_recall_at_fixed_precision` and
    :func:`~paddlemetrics.functional.classification.multilabel_recall_at_fixed_precision` for the specific details of
