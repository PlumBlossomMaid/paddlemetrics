...
def binary_sensitivity_at_specificity(
    ...
    Example:
        >>> from paddlemetrics.functional.classification import binary_sensitivity_at_specificity
...
def _multiclass_sensitivity_at_specificity_compute(
    ...
    sensitivity = paddle.stack([r[0] for r in res])
...
def multiclass_sensitivity_at_specificity(
    ...
    Example:
        >>> from paddlemetrics.functional.classification import multiclass_sensitivity_at_specificity
...
def multilabel_sensitivity_at_specificity(
    ...
    Example:
        >>> from paddlemetrics.functional.classification import multilabel_sensitivity_at_specificity
...
def sensitivity_at_specificity(
    ...
    :func:`~paddlemetrics.functional.classification.binary_sensitivity_at_specificity`,
    :func:`~paddlemetrics.functional.classification.multiclass_sensitivity_at_specificity` and
    :func:`~paddlemetrics.functional.classification.multilabel_sensitivity_at_specificity` for the specific details of
