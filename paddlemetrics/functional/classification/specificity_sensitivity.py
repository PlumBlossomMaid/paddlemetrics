...
def _specificity_at_sensitivity(
    ...
    if not indices.any():
        max_spec = paddle.tensor(0.0, device=specificity.device, dtype=specificity.dtype)
...
def binary_specificity_at_sensitivity(
    ...
    Example:
        >>> from paddlemetrics.functional.classification import binary_specificity_at_sensitivity
...
def multiclass_specificity_at_sensitivity(
    ...
    Example:
        >>> from paddlemetrics.functional.classification import multiclass_specificity_at_sensitivity
...
def multilabel_specificity_at_sensitivity(
    ...
    Example:
        >>> from paddlemetrics.functional.classification import multilabel_specificity_at_sensitivity
...
def specificity_at_sensitivity(
    ...
    :func:`~paddlemetrics.functional.classification.binary_specificity_at_sensitivity`,
    :func:`~paddlemetrics.functional.classification.multiclass_specificity_at_sensitivity` and
    :func:`~paddlemetrics.functional.classification.multilabel_specificity_at_sensitivity` for the specific details of
