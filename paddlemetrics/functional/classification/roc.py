...
def binary_roc(
    ...
    Example:
        >>> from paddlemetrics.functional.classification import binary_roc
...
def multiclass_roc(
    ...
    Example:
        >>> from paddlemetrics.functional.classification import multiclass_roc
...
def multilabel_roc(
    ...
    Example:
        >>> from paddlemetrics.functional.classification import multilabel_roc
...
def roc(
    ...
    :func:`~paddlemetrics.functional.classification.binary_roc`,
    :func:`~paddlemetrics.functional.classification.multiclass_roc` and
    :func:`~paddlemetrics.functional.classification.multilabel_roc` for the specific details of each argument
