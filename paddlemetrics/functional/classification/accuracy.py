...
def binary_accuracy(
    ...
    Example (preds is int tensor):
        >>> from paddle import tensor
        >>> from paddlemetrics.functional.classification import binary_accuracy
...
def multiclass_accuracy(
    ...
    Example (preds is int tensor):
        >>> from paddle import tensor
        >>> from paddlemetrics.functional.classification import multiclass_accuracy
...
def multilabel_accuracy(
    ...
    Example (preds is int tensor):
        >>> from paddle import tensor
        >>> from paddlemetrics.functional.classification import multilabel_accuracy
        >>> target = tensor([[0, 1, 0], [1, 0, 1]])
        >>> preds = tensor([[0, 0, 1], [1, 0, 1]])
...
def accuracy(
    ...
    :func:`~paddlemetrics.functional.classification.binary_accuracy`,
    :func:`~paddlemetrics.functional.classification.multiclass_accuracy` and
    :func:`~paddlemetrics.functional.classification.multilabel_accuracy` for the specific details of
