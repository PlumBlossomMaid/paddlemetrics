...
def _precision_at_recall(
    ...
    try:
        ...
        max_precision = paddle.tensor(0.0, device=precision.device, dtype=precision.dtype)
...
def binary_precision_at_fixed_recall(
    ...
    Example:
        >>> from paddlemetrics.functional.classification import binary_precision_at_fixed_recall
...
def multiclass_precision_at_fixed_recall(
    ...
    Example:
        >>> from paddlemetrics.functional.classification import multiclass_precision_at_fixed_recall
...
def multilabel_precision_at_fixed_recall(
    ...
    Example:
        >>> from paddlemetrics.functional.classification import multilabel_precision_at_fixed_recall
...
def precision_at_fixed_recall(
    ...
    :func:`~paddlemetrics.functional.classification.binary_precision_at_fixed_recall`,
    :func:`~paddlemetrics.functional.classification.multiclass_precision_at_fixed_recall` and
    :func:`~paddlemetrics.functional.classification.multilabel_precision_at_fixed_recall` for the specific details of
