...
def binary_confusion_matrix(
    ...
    Example (preds is int tensor):
        >>> from paddle import tensor
        >>> from paddlemetrics.functional.classification import binary_confusion_matrix
...
def multilabel_confusion_matrix(
    ...
    Example (preds is int tensor):
        >>> from paddle import tensor
        >>> from paddlemetrics.functional.classification import multilabel_confusion_matrix
...
def confusion_matrix(
    ...
    :func:`~paddlemetrics.functional.classification.binary_confusion_matrix`,
    :func:`~paddlemetrics.functional.classification.multiclass_confusion_matrix` and
    :func:`~paddlemetrics.functional.classification.multilabel_confusion_matrix` for
    the specific details of each argument influence and examples.

    Legacy Example:
        >>> from paddle import tensor
        >>> from paddlemetrics.classification import ConfusionMatrix
        >>> target = tensor([1, 1, 0, 0])
        >>> preds = tensor([0, 1, 0, 0])
