...
def binary_specificity(
    ...
    Example (preds is int tensor):
        >>> from paddle import tensor
        >>> from paddlemetrics.functional.classification import binary_specificity
...
def multiclass_specificity(
    ...
    Example (preds is int tensor):
        >>> from paddle import tensor
        >>> from paddlemetrics.functional.classification import multiclass_specificity
...
def multilabel_specificity(
    ...
    Example (preds is int tensor):
        >>> from paddle import tensor
        >>> from paddlemetrics.functional.classification import multilabel_specificity
        >>> target = tensor([[0, 1, 0], [1, 0, 1]])
        >>> preds = tensor([[0, 0, 1], [1, 0, 1]])
...
def specificity(
    ...
    :func:`~paddlemetrics.functional.classification.binary_specificity`,
    :func:`~paddlemetrics.functional.classification.multiclass_specificity` and
    :func:`~paddlemetrics.functional.classification.multilabel_specificity` for the specific
