...
def _cramers_v_compute(confmat: paddle.Tensor, bias_correction: bool) -> paddle.Tensor:
...
def cramers_v(
    ...
    """Compute `Cramer's V`_ statistic measuring the association between two categorical (nominal) data series.
    ...
    Example:
        ...
        >>> from paddlemetrics.functional.nominal import cramers_v
...
def cramers_v_matrix(
    ...
    Example:
        ...
        >>> from paddlemetrics.functional.nominal import cramers_v_matrix
