...
def _char_error_rate(preds: Union[str, list[str]], target: Union[str, list[str]]) -> paddle.Tensor:
    """Wrapper for deprecated import.
...
def _match_error_rate(preds: Union[str, list[str]], target: Union[str, list[str]]) -> paddle.Tensor:
    """Wrapper for deprecated import.
...
def _perplexity(preds: paddle.Tensor, target: paddle.Tensor, ignore_index: Optional[int] = None) -> paddle.Tensor:
    """Wrapper for deprecated import.
...
def _squad(preds: Union[dict[str, str], list[dict[str, str]]], target: SQUAD_TARGETS_TYPE) -> dict[str, paddle.Tensor]:
    """Wrapper for deprecated import.
...
def _word_error_rate(preds: Union[str, list[str]], target: Union[str, list[str]]) -> paddle.Tensor:
    """Wrapper for deprecated import.
...
def _word_information_lost(preds: Union[str, list[str]], target: Union[str, list[str]]) -> paddle.Tensor:
    """Wrapper for deprecated import.
...
def _word_information_preserved(preds: Union[str, list[str]], target: Union[str, list[str]]) -> paddle.Tensor:
    """Wrapper for deprecated import.
