...
def mean_iou(
    ...
    Example:
        ...
        >>> from paddlemetrics.functional.segmentation import mean_iou
        >>> # 4 samples, 5 classes, 16x16 prediction
        >>> preds = randint(0, 2, (4, 5, 16, 16), generator=paddle.Generator().manual_seed(42))
        >>> # 4 samples, 5 classes, 16x16 target
        >>> target = randint(0, 2, (4, 5, 16, 16), generator=paddle.Generator().manual_seed(43))
        ...
        >>> preds = randint(0, 2, (4, 16, 16), generator=paddle.Generator().manual_seed(42))
        >>> target = randint(0, 2, (4, 16, 16), generator=paddle.Generator().manual_seed(43))
