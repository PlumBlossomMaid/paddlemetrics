...
@pytest.mark.parametrize(
    ...
    [
        (
            inputs_8k.preds,
            inputs_8k.target,
            partial(_reference_stoi_batch, fs=8000, extended=True),
            8000,
            True,
        ),
        (
            inputs_16k.preds,
            inputs_16k.target,
            partial(_reference_stoi_batch, fs=16000, extended=True),
            16000,
            True,
        ),
        (
            inputs_8k.preds,
            inputs_8k.target,
            partial(_reference_stoi_batch, fs=8000, extended=False),
            8000,
            False,
        ),
        (
            inputs_16k.preds,
            inputs_16k.target,
            partial(_reference_stoi_batch, fs=16000, extended=False),
            16000,
            False,
        ),
    ],
