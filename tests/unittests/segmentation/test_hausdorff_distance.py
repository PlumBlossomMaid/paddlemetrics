...
NUM_CLASSES = 3
_inputs1 = _Input(
    preds=paddle.randint(low=0, high=2, shape=(NUM_BATCHES, BATCH_SIZE, NUM_CLASSES, 16, 16)),
    target=paddle.randint(low=0, high=2, shape=(NUM_BATCHES, BATCH_SIZE, NUM_CLASSES, 16, 16)),
)
_inputs2 = _Input(
...
_inputs3 = _Input(
    preds=paddle.randint(low=0, high=NUM_CLASSES, shape=(NUM_BATCHES, BATCH_SIZE, 16, 16)),
    target=paddle.randint(low=0, high=2, shape=(NUM_BATCHES, BATCH_SIZE, NUM_CLASSES, 16, 16)),
)
_inputs4 = _Input(
    preds=paddle.randint(low=0, high=2, shape=(NUM_BATCHES, BATCH_SIZE, NUM_CLASSES, 16, 16)),
    target=paddle.randint(low=0, high=NUM_CLASSES, shape=(NUM_BATCHES, BATCH_SIZE, 16, 16)),
)
_inputs5 = _Input(
