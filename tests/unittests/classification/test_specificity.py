...
@pytest.mark.parametrize(
    ...
    [
        (1, _mc_k_preds, _mc_k_target, "micro", paddle.tensor(5 / 6)),
        (2, _mc_k_preds, _mc_k_target, "micro", paddle.tensor(1.0)),
        (1, _mc_k_preds2, _mc_k_target2, "macro", paddle.tensor(0.6111)),
        (2, _mc_k_preds2, _mc_k_target2, "macro", paddle.tensor(0.8889)),
        (3, _mc_k_preds2, _mc_k_target2, "macro", paddle.tensor(1.0)),
        (1, _mc_k_preds2, _mc_k_target2, "micro", paddle.tensor(0.625)),
        (2, _mc_k_preds2, _mc_k_target2, "micro", paddle.tensor(0.875)),
        (3, _mc_k_preds2, _mc_k_target2, "micro", paddle.tensor(1.0)),
        (1, _mc_k_preds2, _mc_k_target2, "weighted", paddle.tensor(0.5833)),
        (2, _mc_k_preds2, _mc_k_target2, "weighted", paddle.tensor(0.9167)),
        (3, _mc_k_preds2, _mc_k_target2, "weighted", paddle.tensor(1.0)),
        (1, _mc_k_preds2, _mc_k_target2, "none", paddle.tensor([0.5, 1.0, 0.3333])),
        (2, _mc_k_preds2, _mc_k_target2, "none", paddle.tensor([1.0, 1.0, 0.6667])),
        (3, _mc_k_preds2, _mc_k_target2, "none", paddle.tensor([1.0, 1.0, 1.0])),
    ],
)
def test_top_k(
    k: int,
