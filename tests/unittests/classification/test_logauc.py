...
from paddlemetrics.utils.imports import _PYTDC_AVAILABLE
...
class TestBinaryLogAUC(MetricTester):
    ...
    def test_binary_logauc_functional(self, inputs, fpr_range, ignore_index):
        ...
        self.run_functional_metric_test(
            ...
            reference_metric=partial(
                _binary_compare_implementation,
                fpr_range=fpr_range,
    ...
    def test_binary_logauc_threshold_arg(self, inputs, threshold_fn):
        ...
        for pred, true in zip(preds, target):
            ...
            ap2 = binary_logauc(pred, true, thresholds=threshold_fn(t.flip(axis=0)))
            assert paddle.allclose(x=ap1, y=ap2, atol=self.atol).item()
