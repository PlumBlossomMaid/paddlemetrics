...
def test_for_correctness(left: str, right: str, substitution_cost: int, expected):
    ...
    for s1, s2 in ((left, right), (right, left)):
        predicted = edit_distance(s1, s2, substitution_cost=substitution_cost)
