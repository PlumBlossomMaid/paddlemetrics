...
def _reference_symmetric_mape(
    ...
    """Symmetric mean absolute percentage error regression loss (SMAPE_).
...
@pytest.mark.parametrize(
    ...
    [
        ...
        pytest.param(
            MeanSquaredLogError,
            mean_squared_log_error,
            sk_mean_squared_log_error,
            {},
            id="mean_squared_log_error",
        ),
        pytest.param(
            WeightedMeanAbsolutePercentageError,
            weighted_mean_absolute_percentage_error,
...
@pytest.mark.parametrize(
    ...
    [
        (
            MeanSquaredError,
            {"squared": "something"},
            "Expected argument `squared` to be a boolean.*",
        ),
        (
            NormalizedRootMeanSquaredError,
            {"normalization": "something"},
            "Argument `normalization` should be either.*",
        ),
    ],
)
